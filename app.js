...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function openOperationLogModal(scheduleId) {
    ...
    const addRow = (initialItemId = null, initialQty = 1) => {
      ...
      div.innerHTML = `
        ...
        <div style="display: flex; align-items: center; gap: 4px;">
          <input type="number" class="form-control consume-qty-input" value="${initialQty}" min="0.001" step="any" required style="max-width:90px;">
          <span class="consume-uom-label" style="font-size:0.75rem; font-weight:700; color:var(--text-medium); min-width: 50px;">Liters</span>
        </div>
